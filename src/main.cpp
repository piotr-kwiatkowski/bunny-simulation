...
int main(int argc, char const *argv[])
{
    ...
    MoveWindow(console, ConsoleRect.left, ConsoleRect.top, 1100, 400, TRUE);
    ...
    */
    ...
    //std::cout << "Click key to close.."; // FIXME: this should be printed on a bottom of the screen
    std::cin.ignore();
